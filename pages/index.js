      ...
      <Head>
        ...
        <div className="headshot"></div>
              ...
              <div id="about" className="pb-10">
                ...
                <div>
                  ...
                  <p className="mb-5">
                    ...
                    improv comedy, and film. In the realm of voice over, Kevin
                    has specialized experience in ADR and commercial work.
                    Clients include Aniplex of America, Sunrights Inc, and
                    Illinois Lottery.
                  </p>
                  <p>
          ...
          <div className="header">
            <div className="flex-col p-6 z-10">
